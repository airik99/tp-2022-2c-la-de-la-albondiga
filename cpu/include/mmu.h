...
uint32_t traducir_direccion_logica(uint32_t);//recibe una direccion logica y devuelve la direccion fisica fijandose si esta en la tlb antes de calcularla, si no esta ahi hace todas las validaciones para agregarla
